...
no-paramètriques per aquestes parelles de variables, porta a les mateixes
conclusions que els p-value resultants de les proves paramètriques. Per tant, 
es pot concloure que la assumpció (opció A detallada en el subapartat anterior) 
de normalitat poblacional -i la conseqüent desviació respecte a la normal- no genera
